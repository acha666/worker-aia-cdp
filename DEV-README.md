...
2. **Wrangler** runs the Worker locally and serves:
   ...
   - API endpoints from `backend/src/`
...
- Look at API handlers in `backend/src/handlers/`
- Review PKI parsing code in `backend/src/pki/`
